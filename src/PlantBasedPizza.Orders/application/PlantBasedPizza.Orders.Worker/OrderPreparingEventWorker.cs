...
public class OrderPreparingEventWorker : BackgroundService
{
    ...
    public OrderPreparingEventWorker(RabbitMqEventSubscriber eventSubscriber, ActivitySource source, OrderPreparingEventHandler eventHandler)
    {
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        var subscription = this._eventSubscriber.CreateEventConsumer(queueName, "kitchen.orderPreparing.v1");
