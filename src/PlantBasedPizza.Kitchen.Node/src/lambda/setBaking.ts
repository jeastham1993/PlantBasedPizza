...
import { SetKitchenRequestBakingCommand, SetKitchenRequestBakingCommandHandler } from "../commands/setKitchenRequestBakingHandler";
...
const commandHandler = new SetKitchenRequestBakingCommandHandler(kitchenRepository, eventPublisher);
...
export const handler = async (event: ALBEvent): Promise<ALBResult> => {
  ...
  const parsedBody: SetKitchenRequestBakingCommand = JSON.parse(event.body!);
