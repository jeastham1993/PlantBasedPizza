...
public class ArchitectureTests
{
    ...
    [InlineData("PlantBasedPizza.OrderManager.Infrastructure", new[] { "PlantBasedPizza.Recipes.Core", "PlantBasedPizza.Kitchen.Core", "PlantBasedPizza.Deliver.Core", "PlantBasedPizza.Recipes.Infrastructure", "PlantBasedPizza.Payment.Core", "PlantBasedPizza.Payment.Infrastructure", "PlantBasedPizza.Kitchen.Infrastructure", "PlantBasedPizza.Deliver.Infrastructure" })]
